...
### v2.3.1 (conf_v2.3.1.js) - 最新版 ⭐
- **架构**：节点池与业务组分离设计（v2.3.0 规则增强版）
- **新增**：
  - AI 规则大幅扩充，覆盖 Google AI Studio、Nvidia API、Meta AI、xAI Grok 等最新服务
  - 视频流媒体规则完善，支持 Disney+、Prime Video、HBO Max 等主流平台
  - 开发工具直连优化，VSCode、JetBrains 系列下载加速
  - 国内应用直连增强，微信、飞书、钉钉、网盘等流量不走代理
  - 广告拦截规则升级，涵盖国内外主流广告平台和隐私追踪器

### v2.3.0 (conf_v2.3.0.js)
