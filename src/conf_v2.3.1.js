...
const TAG_RULES = {
    name: [
        ...
        { tag: "地区:越南", keywords: ["越南"] },
        { tag: "地区:印尼", keywords: ["印尼"] },
        { tag: "地区:菲律宾", keywords: ["菲律宾"] },
        { tag: "地区:印度", keywords: ["印度"] },
...
const NODE_GROUP_RULES = [
    ...
    },
    {
        ...
        includeTags: ["地区:美国"],
        excludeTags: ["用途:AI", "用途:下载", "用途:游戏", "稳定:低", "倍率:低" ],
        preferTags: ["稳定:高", "带宽:高"],
        fallbackKeys: ["nodeGeneral", "nodeFallback", "all"],
        // nodeAI 风控较严，优先使用更不易触发风控的测速目标（可按需修改）
        autoTest: {
            type: "url-test",
...
const RULE_SECTIONS = {
    ...
    [POLICY.AI]: [
        ...
        { type: "DOMAIN-SUFFIX", value: "generativelanguage.googleapis.com" },
        ...
        // --- Nvidia ---
        { type: "DOMAIN-SUFFIX", value: "integrate.api.nvidia.com" },         // Nvidia API    // 匹配包含 nvidia 关键词的域名

        // --- Google Bard ---
        { type: "DOMAIN-SUFFIX", value: "bard.google.com" },     // Google Bard 官网及服务
        { type: "DOMAIN-KEYWORD", value: "bard" },
    ...
    [POLICY.BLOCK]: [
        ...
        // --- 强力拦截微软遥测与广告 ---
        { type: "DOMAIN-KEYWORD", value: "prod.do.dsp.mp.microsoft.com" },
        { type: "DOMAIN-KEYWORD", value: "events.data.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "browser.events.data.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "mobile.events.data.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "v10.events.data.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "v20.events.data.microsoft.com" },
        ...
        // --- Datadog 错误监控 (Claude 上报) ---
        { type: "DOMAIN-KEYWORD", value: "datadoghq" },         // 拦截 Claude 错误日志上传
    ...
    [POLICY.CN]: [
        // --- 腾讯系：微信/企业微信/微信小程序 ---
        { type: "DOMAIN-SUFFIX", value: "weixin.qq.com" },
        { type: "DOMAIN-SUFFIX", value: "weixinbridge.com" },
        { type: "DOMAIN-SUFFIX", value: "wx.qq.com" },
        { type: "DOMAIN-SUFFIX", value: "wechat.com" },
        { type: "DOMAIN-SUFFIX", value: "servicewechat.com" },
        { type: "DOMAIN-SUFFIX", value: "qpic.cn" },
        { type: "DOMAIN-SUFFIX", value: "gtimg.cn" },
        { type: "DOMAIN-SUFFIX", value: "qlogo.cn" },
        { type: "DOMAIN-SUFFIX", value: "ilinkai.com" },
        // --- 飞书/字节系 ---
        { type: "DOMAIN-SUFFIX", value: "feishu.cn" },
        { type: "DOMAIN-SUFFIX", value: "feishu.net" },
        { type: "DOMAIN-SUFFIX", value: "larkoffice.com" },
        { type: "DOMAIN-SUFFIX", value: "bytedance.com" },
        { type: "DOMAIN-SUFFIX", value: "bytedance.net" },
        { type: "DOMAIN-SUFFIX", value: "byteimg.com" },
        { type: "DOMAIN-SUFFIX", value: "bytegoofy.com" },
        { type: "DOMAIN-SUFFIX", value: "ibytedtos.com" },
        { type: "DOMAIN-SUFFIX", value: "tosv.org" },
        // --- 钉钉/阿里系办公 ---
        { type: "DOMAIN-SUFFIX", value: "dingtalk.com" },
        { type: "DOMAIN-SUFFIX", value: "dingtalkapps.com" },
        { type: "DOMAIN-SUFFIX", value: "aliwork.com" },
        // --- 微软国内遥测与推送 ---
        { type: "DOMAIN-SUFFIX", value: "events.data.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "cloudmessaging.edge.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "arc.msn.com" },
        { type: "DOMAIN-SUFFIX", value: "edge.microsoft.com" },
        { type: "DOMAIN-SUFFIX", value: "substrate.office.com" },
        // --- 小米系 ---
        { type: "DOMAIN-SUFFIX", value: "xiaomi.com" },
        { type: "DOMAIN-SUFFIX", value: "xiaomi.net" },
        { type: "DOMAIN-SUFFIX", value: "mi.com" },
        { type: "DOMAIN-SUFFIX", value: "micont.com" },
        // --- 新浪股票（TrafficMonitor 用） ---
        { type: "DOMAIN-SUFFIX", value: "sinajs.cn" },
        // --- 联想 ---
        { type: "DOMAIN-SUFFIX", value: "lenovo.com" },
        { type: "DOMAIN-SUFFIX", value: "lenovomm.com" },
        { type: "DOMAIN-SUFFIX", value: "lenovocloud.com" },
            // --- 新增：开发者工具直连 (提速) ---
        { type: "DOMAIN-SUFFIX", value: "vscode-cdn.net" },
        { type: "DOMAIN-SUFFIX", value: "update.code.visualstudio.com" },
        { type: "DOMAIN-SUFFIX", value: "vscode-unpkg.net" },
        { type: "DOMAIN-SUFFIX", value: "jetbrains.com" },
        { type: "DOMAIN-SUFFIX", value: "download.jetbrains.com" },
        { type: "DOMAIN-SUFFIX", value: "download-cdn.jetbrains.com" },
        { type: "DOMAIN-SUFFIX", value: "plugins.jetbrains.com" },
    ...
    // --- 本地与局域网域名 ---
        ...
        // --- 沉浸翻译 (国产插件) ---
        { type: "DOMAIN-SUFFIX", value: "immersivetranslate.com" },  // 沉浸翻译插件直连

        // --- AdBlock 规则下载 ---
        { type: "DOMAIN-SUFFIX", value: "adblockplus.org" },  // Easylist 规则下载直连
...
function buildProxyGroups(nodePools) {
    ...
    NODE_GROUP_RULES.forEach((rule) => {
        const autoTest = rule.autoTest || RUNTIME_CONFIG.autoTest;

        groups.push({
            name: rule.name,
            type: autoTest.type,
            url: autoTest.url,
            interval: autoTest.interval,
            tolerance: autoTest.tolerance,
